...
// </div>
// }
const LazyComponent = ({ children }: {children: any}) => <Suspense fallback={<Loading open  />}>{children}</Suspense>;
  ...
  createRoutesFromElements(
    <>
      ...
      <Route path="/" element={<ProtectedLayout />} errorElement={<ErrorBoundary />}>
        <Route index element={<Navigate to="private" />} errorElement={<ErrorBoundary />} />
        <Route path="private" errorElement={<ErrorBoundary />}>
          <Route path="" element={<LazyComponent children={<PrivateAuction />} />} errorElement={<ErrorBoundary />}/>
        {/* <Route path="" /> */}
          <Route path="survey/question/:id" element={<LazyComponent children={<Home />} />} errorElement={<ErrorBoundary />} />
