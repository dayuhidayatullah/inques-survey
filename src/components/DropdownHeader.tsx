...
const DropdownHeader = ({ isOpen, username, imageSrc, setIsOpen}:{isOpen: boolean, username: string, imageSrc: string, setIsOpen: Dispatch<SetStateAction<boolean>>}) => {
  ...
  return isOpen && (
    <div className='absolute bg-white top-[48px]  min-w-[300px] shadow-sm shadow-gray-400 pt-3 pl-4 pb-3 pr-4 rounded-md flex flex-col gap-3' ref={refDropdown}>
        ...
        <div className='flex gap-2 items center'>
          <div className='bg-gray-400 rounded-[50%] p-1 text-center flex items-center justify-center cursor-pointer' onClick={() => {
            logout()
        }}>
