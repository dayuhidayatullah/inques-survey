...
export const sideBarContentWidth = 80;
export const appBarHeight = 80;

export const tokenString = 'access_token';
...
// export const userAvatarString = 'markPlus-userAvatar';
// export const userMaxIdleTime = 'markPlus-maxIdleTime';